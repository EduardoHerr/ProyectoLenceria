<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos/MainPage.Master" AutoEventWireup="true" CodeBehind="ParteInferior.aspx.cs" Inherits="ProyectoLenceria.Mantenimientos.ParteInferior" %>
                            ...
                            <div class="col">
                                <div class="card" style="width: 18rem">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <asp:LinkButton ID="lnkComprar" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"proId") %>' runat="server" OnCommand="lnkComprar_Command" CssClass="btn btn-primary">Comprar</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
