<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos/MainPage.Master" AutoEventWireup="true" CodeBehind="ParteSuperior.aspx.cs" Inherits="ProyectoLenceria.Mantenimientos.ParteSuperior" %>
                            ...
                            <div class="col">
                                <div class="card" style="width: 18rem">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <asp:LinkButton ID="lnkComprar" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"proId") %>' OnCommand="lnkComprar_Command" runat="server" CssClass="btn btn-primary">Comprar</asp:LinkButton>
                                    </div>
                                </div>
                            </div>
